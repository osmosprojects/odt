...
/**
 * Safely unserializes PHP serialized data or JSON data, returning null on failure instead of throwing.
 */
export function safePhpUnserialize(serialized: string | null | undefined): any {
